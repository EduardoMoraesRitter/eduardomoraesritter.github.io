...
async page=>{
 ...
 await page.goto('http://127.0.0.1:4322/farol4-staging/index.html');
 ...
 r.on('dialog',d=>d.accept());await r.goto('http://127.0.0.1:4322/farol4-staging/index.html');await r.waitForTimeout(400);
